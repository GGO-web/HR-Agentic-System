...
- **Icons**: Always use Lucide React icons from [https://lucide.dev/icons/](https://lucide.dev/icons/) - never use inline SVGs
...
### Icon Usage (always use Lucide React icons)
```typescript
// Import icons from lucide-react
import { FileText, Mic, GitBranch, User, Settings } from "lucide-react"

// Use icons with consistent sizing and styling
